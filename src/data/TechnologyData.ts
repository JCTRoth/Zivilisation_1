...
export const TECHNOLOGIES_DATA: Technology[] = [
  ...
  { id: "currency", name: "Currency", researched: false, researching: false, cost: 60, description: "Leads to Trade and allows building of marketplaces.", prerequisites: ["bronze_working"] },

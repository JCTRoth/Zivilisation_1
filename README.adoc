...
[.text-center]
--
image::doc/1.jpg[Screenshot 1, width=800]

image::doc/world_map.png[World Map, width=800]

image::doc/Bildschirmfoto_20260906_003420.png[Screenshot 1, width=800]
image::doc/Bildschirmfoto_20260906_003442.png[Screenshot 2, width=800]

image::doc/2.png[Screenshot 2, width=800]

image::doc/3.png[Screenshot 3, width=800]

image::doc/2_1.png[Screenshot 2, width=800]
image::doc/4.png[Screenshot 4, width=800]
image::doc/5.png[Screenshot 5, width=800]
...
**Trireme** (1/1/3) - Naval 
transport (Map Making)

**Pikemen** (1/2/1) - Medieval 
defensive unit (Feudalism)
...
We are using Git LFS for large assets, +
...
* link:doc/save-load-system.adoc[Save & Load System] — Implementation details for game save/load and Diplomacy Report leader portrait system
...
Or just write me an E-Mail and we talk: info@mailbase.info
...
This is a static single-page application (SPA) built with Vite. After building, deploy the `dist/` folder contents to any static web host.
